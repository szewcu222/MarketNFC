...
namespace MarketNFC.Migrations
{
    ...
    [Migration("20180817170307_repairModels")]
            ...
            modelBuilder.Entity("MarketNFC.Models.Lodowka", b =>
                {
                    ...
                    b.HasData(
                        new { LodowkaId = 1, DataAktualizacji = new DateTime(2018, 8, 17, 19, 3, 7, 385, DateTimeKind.Local), GrupaId = 1, Pojemnosc = 10 },
                        new { LodowkaId = 2, DataAktualizacji = new DateTime(2018, 8, 17, 19, 3, 7, 387, DateTimeKind.Local), GrupaId = 2, Pojemnosc = 15 },
                        new { LodowkaId = 3, DataAktualizacji = new DateTime(2018, 8, 17, 19, 3, 7, 387, DateTimeKind.Local), GrupaId = 3, Pojemnosc = 12 }
                    );
                });
            ...
            modelBuilder.Entity("MarketNFC.Models.Produkt", b =>
                {
                    ...
                    b.HasData(
                        new { ProduktId = 1, Cena = 5f, DataWaznosci = new DateTime(2018, 8, 17, 19, 3, 7, 392, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 1111, Nazwa = "SZAMPON", NumerPartiiProdukcyjnej = 1111, Producent = "SYOSS", RFIDTag = "1111" },
                        new { ProduktId = 2, Cena = 10f, DataWaznosci = new DateTime(2018, 8, 17, 19, 3, 7, 392, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 2222, Nazwa = "COLA", NumerPartiiProdukcyjnej = 2222, Producent = "SYOSS", RFIDTag = "2222" },
                        new { ProduktId = 3, Cena = 15f, DataWaznosci = new DateTime(2018, 8, 17, 19, 3, 7, 392, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 3333, Nazwa = "SZAMPON", NumerPartiiProdukcyjnej = 3333, Producent = "SYOSS", RFIDTag = "3333" },
                        new { ProduktId = 4, Cena = 20f, DataWaznosci = new DateTime(2018, 8, 17, 19, 3, 7, 392, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 4444, Nazwa = "PEPSI", NumerPartiiProdukcyjnej = 4444, Producent = "COLACOMP", RFIDTag = "4444" },
                        new { ProduktId = 5, Cena = 30f, DataWaznosci = new DateTime(2018, 8, 17, 19, 3, 7, 392, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 5555, Nazwa = "PAWO", NumerPartiiProdukcyjnej = 5555, Producent = "HARNAS", RFIDTag = "5555" }
                    );
                });
            ...
            modelBuilder.Entity("MarketNFC.Models.Uzytkownik", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1", AccessFailedCount = 0, ConcurrencyStamp = "372e5653-db9a-42fe-bee7-249dbdc8f57e", DataRejestracji = new DateTime(2018, 8, 17, 19, 3, 7, 388, DateTimeKind.Local), Email = "szewcu222@gmail.com", EmailConfirmed = false, Imie = "Darek", LiczbaZamowien = 0m, LockoutEnabled = false, Nazwisko = "Malysz", PhoneNumberConfirmed = false, TwoFactorEnabled = false },
                        new { Id = "2", AccessFailedCount = 0, ConcurrencyStamp = "c73b9b7c-d893-4943-912a-7b9312625ec3", DataRejestracji = new DateTime(2018, 8, 17, 19, 3, 7, 388, DateTimeKind.Local), Email = "miska@gmail.com", EmailConfirmed = false, Imie = "Misia", LiczbaZamowien = 0m, LockoutEnabled = false, Nazwisko = "Mis", PhoneNumberConfirmed = false, TwoFactorEnabled = false },
                        new { Id = "3", AccessFailedCount = 0, ConcurrencyStamp = "17f3e91a-3305-4a4c-be56-123f8561e0fb", DataRejestracji = new DateTime(2018, 8, 17, 19, 3, 7, 388, DateTimeKind.Local), Email = "sobek44@gmail.com", EmailConfirmed = false, Imie = "Sebke", LiczbaZamowien = 0m, LockoutEnabled = false, Nazwisko = "Szczepankiewicz", PhoneNumberConfirmed = false, TwoFactorEnabled = false },
                        new { Id = "4", AccessFailedCount = 0, ConcurrencyStamp = "7375f74d-4f89-414e-8aee-3f82aabfb393", DataRejestracji = new DateTime(2018, 8, 17, 19, 3, 7, 388, DateTimeKind.Local), Email = "kozula@gmail.com", EmailConfirmed = false, Imie = "MIchal", LiczbaZamowien = 0m, LockoutEnabled = false, Nazwisko = "Kozubek", PhoneNumberConfirmed = false, TwoFactorEnabled = false }
                    );
                });
