...
namespace MarketNFC.Migrations
{
    ...
    [Migration("20180817160024_addLiczbaZamowienToUzywkownik")]
    partial class addLiczbaZamowienToUzywkownik
    {
            ...
            modelBuilder.Entity("MarketNFC.Models.Lodowka", b =>
                {
                    ...
                    b.HasData(
                        new { LodowkaId = 1, DataAktualizacji = new DateTime(2018, 8, 17, 18, 0, 23, 760, DateTimeKind.Local), GrupaId = 1, Pojemnosc = 10 },
                        new { LodowkaId = 2, DataAktualizacji = new DateTime(2018, 8, 17, 18, 0, 23, 762, DateTimeKind.Local), GrupaId = 2, Pojemnosc = 15 },
                        new { LodowkaId = 3, DataAktualizacji = new DateTime(2018, 8, 17, 18, 0, 23, 762, DateTimeKind.Local), GrupaId = 3, Pojemnosc = 12 }
                    );
                });
            ...
            modelBuilder.Entity("MarketNFC.Models.Produkt", b =>
                {
                    ...
                    b.HasData(
                        new { ProduktId = 1, Cena = 5f, DataWaznosci = new DateTime(2018, 8, 17, 18, 0, 23, 765, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 1111, Nazwa = "SZAMPON", NumerPartiiProdukcyjnej = 1111, Producent = "SYOSS", RFIDTag = "1111" },
                        new { ProduktId = 2, Cena = 10f, DataWaznosci = new DateTime(2018, 8, 17, 18, 0, 23, 765, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 2222, Nazwa = "COLA", NumerPartiiProdukcyjnej = 2222, Producent = "SYOSS", RFIDTag = "2222" },
                        new { ProduktId = 3, Cena = 15f, DataWaznosci = new DateTime(2018, 8, 17, 18, 0, 23, 765, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 3333, Nazwa = "SZAMPON", NumerPartiiProdukcyjnej = 3333, Producent = "SYOSS", RFIDTag = "3333" },
                        new { ProduktId = 4, Cena = 20f, DataWaznosci = new DateTime(2018, 8, 17, 18, 0, 23, 765, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 4444, Nazwa = "PEPSI", NumerPartiiProdukcyjnej = 4444, Producent = "COLACOMP", RFIDTag = "4444" },
                        new { ProduktId = 5, Cena = 30f, DataWaznosci = new DateTime(2018, 8, 17, 18, 0, 23, 765, DateTimeKind.Local), GlobalnyNumerJednostkiHandlowej = 5555, Nazwa = "PAWO", NumerPartiiProdukcyjnej = 5555, Producent = "HARNAS", RFIDTag = "5555" }
                    );
                });
            ...
            modelBuilder.Entity("MarketNFC.Models.Uzytkownik", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "1", AccessFailedCount = 0, ConcurrencyStamp = "4a7121de-b67f-4ad6-b6e7-c533f325386f", DataRejestracji = new DateTime(2018, 8, 17, 18, 0, 23, 763, DateTimeKind.Local), Email = "szewcu222@gmail.com", EmailConfirmed = false, Imie = "Darek", LiczbaZamowien = 0m, LockoutEnabled = false, Nazwisko = "Malysz", PhoneNumberConfirmed = false, TwoFactorEnabled = false },
                        new { Id = "2", AccessFailedCount = 0, ConcurrencyStamp = "ff5e21b0-f9c9-4a30-adf7-2e0a826cb2f6", DataRejestracji = new DateTime(2018, 8, 17, 18, 0, 23, 763, DateTimeKind.Local), Email = "miska@gmail.com", EmailConfirmed = false, Imie = "Misia", LiczbaZamowien = 0m, LockoutEnabled = false, Nazwisko = "Mis", PhoneNumberConfirmed = false, TwoFactorEnabled = false },
                        new { Id = "3", AccessFailedCount = 0, ConcurrencyStamp = "a0e77578-c003-4f40-9865-f2ae61b9cec7", DataRejestracji = new DateTime(2018, 8, 17, 18, 0, 23, 763, DateTimeKind.Local), Email = "sobek44@gmail.com", EmailConfirmed = false, Imie = "Sebke", LiczbaZamowien = 0m, LockoutEnabled = false, Nazwisko = "Szczepankiewicz", PhoneNumberConfirmed = false, TwoFactorEnabled = false },
                        new { Id = "4", AccessFailedCount = 0, ConcurrencyStamp = "351d1691-1d37-424b-8848-cba881f41a1c", DataRejestracji = new DateTime(2018, 8, 17, 18, 0, 23, 763, DateTimeKind.Local), Email = "kozula@gmail.com", EmailConfirmed = false, Imie = "MIchal", LiczbaZamowien = 0m, LockoutEnabled = false, Nazwisko = "Kozubek", PhoneNumberConfirmed = false, TwoFactorEnabled = false }
                    );
                });
